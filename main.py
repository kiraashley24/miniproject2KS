...
data = pd.read_csv('happiness.csv', index_col='Global rank')

dataTen = data.head(10)
print(dataTen)
...
def getGraph():
    dataTen['Happiness index, 2022'].plot()
    plt.xlabel("Global rank")
    plt.ylabel("Happiness Index")
    plt.title("Countries ranked by Happiness Index")
    plt.show()
